      ...
      <div class="row">
        <div class="col-12">
          <table style="border-collapse: collapse; width: 100%;">
            <tr style="background-color: #AE75DA;">
          ...
          <br>
          <table style="border-collapse: collapse; width: 100%;">
            <tr style="background-color: #91ADC8;">
            ...
            <tr>
              <td style="border: 1px solid black; padding: 8px;">Sabring</td>
              <td style="border: 1px solid black; padding: 8px;">sabring007@gmail.com</td>
              <td style="border: 1px solid black; padding: 8px;">Kulkas</td>
              <td style="border: 1px solid black; padding: 8px;">10</td>
            </tr>
          </table>
